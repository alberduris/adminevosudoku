...
public class VentanaActivarSudoku extends JDialog implements Observer {
	 ...
	 * @throws IOException 
	 */
	public VentanaActivarSudoku() throws LineUnavailableException, IOException, UnsupportedAudioFileException {
	...
	private void crearNorte(final String pIdent, final int pDif){	
		ident = null;
		dif = null;
		...
		ident = new JComboBox<String>(cS.obtListaEstado(pDif+1, false));
	...
	private JButton getBtn1() {
		if(btn1 == null){
			...
			btn1.addActionListener(new ActionListener(){
				...
				public void actionPerformed(ActionEvent arg0) {
					norte.removeAll();
					gA.modificarEstadoSudoku(true);
					if(cS.obtListaEstado(dif.getSelectedIndex()+1, false).length != 0){
	...
	private void crearDialogoFinal(){
		...
		JLabel txt = new JLabel("El Sudoku se ha activado correctamente");
	...
	private void crearDialogoNoExisten(){
		...
		JLabel txt = new JLabel("No existen Sudokus para activar");
		JButton boton = new JButton("Continuar");
